...
def following_assign(followingList, num_of_following, followingKey):
    for i in range(0, len(followingList)):
        if i < num_of_following:
            followingList[i].type = followingKey
        else:
            followingList[i].type = 'elective'
