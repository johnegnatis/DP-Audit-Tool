    ...
    return (
        <div className="home-page-root">
            <div className='home-page'>
                ...
                >
                    <Icon icon={!!(studentObject) ? iconNames.checkbox : iconNames.file} className='icon orange medium'/>
                    <span className="info">{!!(studentObject) ? '(Implement File Name Here).pdf' : 'Student Transcript or Degree Plan'}</span>
                    <span className="info-subtitle">{!!(studentObject) ? 'Click again to remove' : 'Click to Upload.'}</span>
                </div>
